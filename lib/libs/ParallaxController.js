...
function ParallaxController() {
    ...
    function _setupOffsets(element) {
        var _element$props = element.props,
            ...
            rotateMin = _element$props.rotateMin,
            rotateMax = _element$props.rotateMax;
        ...
        var rMin = (0, _index.parseValueAndUnit)(rotateMin, 'deg');
        var rMax = (0, _index.parseValueAndUnit)(rotateMax, 'deg');
